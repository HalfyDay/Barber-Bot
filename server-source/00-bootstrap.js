...
app.use((req, res, next) => {
  ...
  res.setHeader(
    ...
    [
      ...
      "form-action 'self' https://id.vk.ru https://login.vk.ru https://oauth.vk.com https://vk.com https://*.vk.com",
      "manifest-src 'self'",
      "img-src 'self' data: blob: https:",
      "font-src 'self' data: https://fonts.gstatic.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "script-src 'self' 'unsafe-inline' https://unpkg.com",
      "connect-src 'self' https://unpkg.com https://id.vk.ru https://login.vk.ru https://oauth.vk.com https://api.vk.com https://vk.com https://*.vk.com",
      "frame-src 'self' https://id.vk.ru https://login.vk.ru https://oauth.vk.com https://vk.com https://*.vk.com",
