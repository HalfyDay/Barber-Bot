...
const licenseMiddleware = async (req, res, next) => {
  ...
  try {
    ...
    res.status(403).json({ error: '�������� ���������������', details: error.message, status: getLicenseStatus() });
  }
};
const startLicenseWatcher = () => {
  setInterval(() => {
    ensureLicenseValid().catch((error) => console.warn('�������� �������� �� �������:', error.message));
